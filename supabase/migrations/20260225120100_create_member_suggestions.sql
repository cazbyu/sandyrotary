...
CREATE TABLE IF NOT EXISTS "0012-sr-member-suggestions" (
...
ALTER TABLE "0012-sr-member-suggestions" ENABLE ROW LEVEL SECURITY;

-- Members can read their own suggestions
CREATE POLICY "Members can read own suggestions"
  ON "0012-sr-member-suggestions"
  FOR SELECT
  TO authenticated
